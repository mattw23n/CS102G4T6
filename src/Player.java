...
=======
    ...
    public void chooseRange() {
        ...
        try {
            ...
            // Sorts lower and upper originals automatically
            int lowerValue = Utils.getCardValueInt(lower);
            int upperValue = Utils.getCardValueInt(upper);
    ...
    //         System.out.println("Selected upper bound");
    ...
    //     }else{
    //         System.out.println("Selected lower bound");
